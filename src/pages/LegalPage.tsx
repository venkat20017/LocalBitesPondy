...
const DESCRIPTION_MAP: Record<LegalSlug, string> = {
  'privacy-policy':
    'How LocalBitesPondy collects, uses, and protects your personal data. Email-only opt-in, never sold or shared.',
  'terms-of-use':
    'The terms governing your use of LocalBitesPondy content, including the free Pondicherry food guide.',
};
...
export default function LegalPage({ slug }: { slug: LegalSlug }) {
  ...
  const description = data?.seo?.metaDescription ?? DESCRIPTION_MAP[slug];
